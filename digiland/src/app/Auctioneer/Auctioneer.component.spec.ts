...
describe('AuctioneerComponent', () => {
  ...
  let mockAuctioneerService;
  let mockDataService

  beforeEach(async(() => {

    mockAuctioneerService = sinon.createStubInstance(AuctioneerService);
    mockAuctioneerService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: AuctioneerService, useValue: mockAuctioneerService },
